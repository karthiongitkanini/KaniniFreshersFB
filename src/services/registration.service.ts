...
update(val:string):Observable<any>
    {
        ...
        var reqHeader=new HttpHeaders({'No-Auth':'True'});
    return this.myHttp.get("https://localhost:44381/api/admin/getdetails?uid="+val,{headers:reqHeader})
...
updated(flight:Flightex,value)
    ...
    //  console.log(flight);
      ...
      var reqHeader=new HttpHeaders({'No-Auth':'True'});
      return this.myHttp.put("https://localhost:44381/api/admin/updatedetails?id="+value,flight,{headers:reqHeader})
